...
function setup() {
    ...
    add_image_size('jumbotron-thumb', 1920, 9999); //300 pixels wide (and unlimited height)
...
function assets() {
    ...
    if (is_page('contact')) {
        ...
        wp_enqueue_script('sage/googlemaps.js', Assets\asset_path('scripts/googlemaps.js'), ['sage/js'], null, true);
